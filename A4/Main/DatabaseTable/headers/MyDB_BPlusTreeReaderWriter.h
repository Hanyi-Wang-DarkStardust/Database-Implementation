...
public:
    ...
    vector<vector<vector<MyDB_RecordPtr>>> getPrintTreeLevel(int root);
...
private:
    ...
    getRangeIterHelper(vector<MyDB_PageReaderWriter> &list, MyDB_AttValPtr low, MyDB_AttValPtr high, bool needSort);
